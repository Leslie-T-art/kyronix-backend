...
public class ServletAuditAutoConfiguration {
    ...
    @Bean
    ServletAuditTrailFilter servletAuditTrailFilter(PlatformAuditPublisher auditPublisher,
                                                    Clock platformAuditClock,
                                                    Environment environment) {
        return new ServletAuditTrailFilter(
                auditPublisher,
                platformAuditClock,
